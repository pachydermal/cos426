...
SystemSettings.mySystem = {
    ...
    // Particle Material
    particleMaterial :  SystemSettings.myMaterial,
...
SystemSettings.axisBox = {

    // Particle material
    particleMaterial :  SystemSettings.standardMaterial,

    // Initialization
    initializerFunction : AxisBoxInitializer,
    initializerSettings : {
        sphere:   new THREE.Vector4 ( 0.0, 30.0, 0.0, 1.0 ),
        color:    new THREE.Vector4 ( 0.0, 0.0, 1.0, 1.0 ),
        velocity: new THREE.Vector3 ( 0.0, 30.0, 0.0),
    ...
    updaterSettings : {
        externalForces : {
            gravity :     new THREE.Vector3( -20, 0, 0),
            attractors : [],
        },
        collidables: {
            bounceBoxes: [ {boxDef: {xmin:9, xmax:21, ymin: 14, ymax:66, zmin:9, zmax:21}, damping : 0.8 },{boxDef: {xmin:-5, xmax:5, ymin: 15, ymax:65, zmin:0, zmax:10}, damping : 0.8 },{boxDef: {xmin:-5, xmax:5, ymin: 15, ymax:65, zmin:20, zmax:30}, damping : 0.8 }],
        },
    },
