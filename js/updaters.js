...
function FriendUpdater ( opts ) {
    this._opts = opts;
    return this;
};


FriendUpdater.prototype.updatePositions = function ( particleAttributes, alive, delta_t ) {
    var positions  = particleAttributes.position;
    var velocities = particleAttributes.velocity;
...
FriendUpdater.prototype.updateVelocities = function ( particleAttributes, alive, delta_t ) {
...
FriendUpdater.prototype.updateColors = function ( particleAttributes, alive, delta_t ) {
    var colors    = particleAttributes.color;
    var lifetimes = particleAttributes.lifetime.array;
    var maxlife = Math.max(0,Math.max.apply( Math, lifetimes )*0.5);
...
FriendUpdater.prototype.updateSizes= function ( particleAttributes, alive, delta_t ) {
    var sizes    = particleAttributes.size;
...
FriendUpdater.prototype.updateLifetimes = function ( particleAttributes, alive, delta_t) {
    var positions     = particleAttributes.position;
    var lifetimes     = particleAttributes.lifetime;
...
FriendUpdater.prototype.collisions = function ( particleAttributes, alive, delta_t ) {
    if ( !this._opts.collidables ) {
        return;
    }
    if ( this._opts.collidables.bouncePlanes ) {
...
FriendUpdater.prototype.update = function ( particleAttributes, alive, delta_t ) {
